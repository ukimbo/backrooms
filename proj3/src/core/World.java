...
public class World {
    ...
    public void gameRulesScreen() {
        StdDraw.clear(StdDraw.BLACK);
        StdDraw.setPenColor(StdDraw.WHITE);
        StdDraw.text(40, 40, "Here are the rules of the game!");
        StdDraw.text(40, 30, "Navigate through the backrooms, a maze of mystery full of quiet corridors and rooms!");
        StdDraw.text(40, 28, "All to find the right key that unlocks the exit door.");
        StdDraw.text(40, 20, "!WARNING!");
        StdDraw.text(40, 18, "!WARNING!");
        StdDraw.text(40, 16, "!WARNING!");
        StdDraw.text(40, 10, "If you don't escape you'll be lost forever...");
        StdDraw.show();
        boolean chooseTheme = true;
        while (chooseTheme) {
            if (StdDraw.hasNextKeyTyped()) {
